...
//     function applyVariantStyles(previewElement, reset = false) {
...
//         // Check if there's an old image to remove
...
//                 duration: 0.5,
//                 onComplete: () => {
//                     // Check if the old image is still a child of previewBg
//                     if (oldImg.parentNode === previewBg) {
...
//             if (newActivePreview) { // Check if newActivePreview exists
//                 if (activePreview && activePreview !== newActivePreview) {
//                     const previousActivePreviewImg = activePreview.querySelector(".preview-img");
//                     if (previousActivePreviewImg) { // Check if previousActivePreviewImg exists
...
//             setTimeout(() => {
//                 if (!isMouseOverItem) {
//                     changeBg("./images/default-bg.webp");
//                     if(activePreview) {
