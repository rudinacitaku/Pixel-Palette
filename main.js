...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const defaultClipPaths={
        ...
        "variant-1":"polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)",
    };
    ...
    previews.forEach((preview, index)=>{
        ...
        <div class="preview-title"><img src="${preview.title}" alt=""/> </div>
        <div class="preview-tags"><img src="${preview.tags}" alt=""/> </div>
        <div class="preview-description"><img src="${preview.description}" alt=""/> </div>
        `;
